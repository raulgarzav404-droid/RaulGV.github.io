...
## Portafolio
### Proyecto 1: Análisis de vulnerabilidades en [sistema]
* Descripción: [breve descripción del proyecto]
* Tecnologías utilizadas: [lista de tecnologías]
* Resultados: [breve descripción de los resultados]
* [Enlace a repositorio de código o demostración en vivo](enlace)

### Proyecto 2: Desarrollo de herramienta de seguridad para [propósito]
* Descripción: [breve descripción del proyecto]
* Tecnologías utilizadas: [lista de tecnologías]
* Resultados: [breve descripción de los resultados]
* [Enlace a repositorio de código o demostración en vivo](enlace)
...
### Categorías
* [Seguridad de redes](enlace)
* [Criptografía](enlace)
* [Malware y análisis de malware](enlace)
